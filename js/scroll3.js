$(document).ready(function(){
  ...
  // 오른쪽 퀵메뉴_________________________

  $("#scroll_btn").hide();  //퀵메뉴 숨기기

  //스크롤이 350이상일때  퀵메뉴 보이게 하고 스크롤을 올리면 다시 숨김
  $(window).scroll(function(){
  ...
  $(window).scroll(function(){
    ...
    if(scollpos>=800 && scollpos<1600){
      $("#scroll_btn ul .scb2").css({"width":"110px","border-radius":"25px","transition":"0.3s"});
    ...
    if(scollpos>=1600 && scollpos<3000){
      $("#scroll_btn ul .scb3").css({"width":"110px","border-radius":"25px","transition":"0.3s"});
